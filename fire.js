var FireDoom = function () {
    ...
    function createDataStrucure() {
        const numberOfPixels = fireWidth * fireHeigth;
        firePixelArray = new Array(numberOfPixels).fill(0);
    ...
    function updateFireIntensityPerPixel(currentPixel) {
        ...
        const belowPixeFireIntensity = firePixelArray[belowPixel];
        const newFireIntensity = belowPixeFireIntensity - decay;
        firePixelArray[currentPixel - decay] = belowPixeFireIntensity - decay >= 0 ? belowPixeFireIntensity - decay : 0
